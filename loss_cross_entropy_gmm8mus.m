function [loss,A_SPF8,phi_SPF8,p_start_SPF8] = loss_cross_entropy_gmm8mus(w, X, y_true,X_NS0,NS0_w0,X_DF5,DF5_w0,X_FF6,FF6_w0,X_AF7,AF7_w0,X_SPF8,SPF8_w0,X_GF9,GF9_w0)
...
X_WF_validate_SPF8 = X*w;
X_WF_validate_GF9 = X*GF9_w0;
